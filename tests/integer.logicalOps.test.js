...
testing('isPrime',bigInteger.isPrime('104729'),true)
testing('isComposite',bigInteger.isComposite('104729'),false)
testing('isOdd',bigInteger.isOdd('9999999999'),true)
testing('isEven',bigInteger.isEven('9999999999'),false)
testing('isPositive',bigInteger.isPositive('9.8'),true)
testing('isNegative',bigInteger.isNegative('-899'),true)
testing('isZero',bigInteger.isZero('0.1'),false)