...
testing('isPrime',bigDecimal.isPrime('104729'),true)
testing('isComposite',bigDecimal.isComposite('104729'),false)
testing('isOdd',bigDecimal.isOdd('9999999999'),true)
testing('isEven',bigDecimal.isEven('9999999999'),false)
testing('isPositive',bigDecimal.isPositive('9.8'),true)
testing('isNegative',bigDecimal.isNegative('-899'),true)
testing('isZero',bigDecimal.isZero('0.1'),false)